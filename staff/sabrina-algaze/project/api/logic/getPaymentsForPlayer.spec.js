...
describe('getPaymentsForPlayer', () => {
    ...
    beforeEach(() => Promise.all([User.deleteMany(), Group.deleteMany(), Training.deleteMany(), Payment.deleteMany()]))
    ...
    afterEach(() => Promise.all([User.deleteMany(), Group.deleteMany(), Training.deleteMany(), Payment.deleteMany()]))
