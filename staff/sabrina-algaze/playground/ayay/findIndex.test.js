...
console.info('CASE returns the index of the first element from ayay that satisfies the provided testing callback')

{
    ...
    const foundIndex = nums.findIndex((element, index, ayay) => {
        iterations++
