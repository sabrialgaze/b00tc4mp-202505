function add(a, b) {
    ...
    if (typeof a !== 'number' || Number.isNaN(a) || a === Infinity) throw new Error ('invalid a type')
    if (arguments.length === 1) return a
    if (typeof b !== 'number' || Number.isNaN(b) || b === Infinity) throw new Error ('invalid b type')   
...
console.info('CASE a is NaN and b is 20 then throws error "invalid a type"')
...
console.info('CASE a is 10 and b is NaN then throws error "invalid b type"')
...
console.info('CASE a is Infinity and b is 20 then throws error "invalid a type"')
...
console.info('CASE a is 10 and b is Infinity then throws error "invalid b type"')
