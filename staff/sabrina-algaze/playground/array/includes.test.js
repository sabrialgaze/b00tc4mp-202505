...
console.info('CASE element is included in the array')
...
console.info('CASE element is not included in the array')
...
console.info('CASE element is included when counting backward from the end of the array')
...
console.info('CASE element is not included when counting backward from the end of the array')
...
console.info('CASE NaN is included in the array')

{
    const nums = [NaN, 10, 20, 30]
